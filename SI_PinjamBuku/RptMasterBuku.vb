...
Public Class RptMasterBuku
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SI_PinjamBuku.RptMasterBuku.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMasterBuku
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMasterBuku = New RptMasterBuku()
        rpt.Site = Me.Site
        Return rpt
    End Function
