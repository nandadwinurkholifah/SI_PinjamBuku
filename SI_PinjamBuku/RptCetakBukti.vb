...
Public Class RptCetakBukti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SI_PinjamBuku.RptCetakBukti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCetakBukti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCetakBukti = New RptCetakBukti()
        rpt.Site = Me.Site
        Return rpt
    End Function
