...
Public Class rptCetakBuku
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SI_PinjamBuku.rptCetakBuku.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCetakBuku
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCetakBuku = New rptCetakBuku()
        rpt.Site = Me.Site
        Return rpt
    End Function
